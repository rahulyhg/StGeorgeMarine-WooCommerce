<?php
/*
Template Name: Portfolio masonry 3 col with title(Deprecated)
*/
...
<section id="layout" class="portfolio-page">
    ...
    <div class="row">
        <div class="twelve columns">
            ...
            <div id="grid-folio" class="col-3 row with-title">
                ...
                while ($wp_query->have_posts()) : $wp_query->the_post();
                    ...
                    <article class="four columns project <?php echo esc_attr($folio_hover_style); ?>">
						<div class="cover">
