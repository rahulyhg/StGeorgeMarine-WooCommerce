<?php
/*
  Template Name: Portfolio grid 3 col with title + right sidebar(Deprecated)
 */
...
<section id="layout" class="portfolio-page dfd-sidebar-right dfd-equal-height-children">
	...
	<div class="row">
		...
		<div id="portfolio-page" class="nine columns dfd-eq-height">
			...
			<div class="works-list mini with-right-sidebar with-title">
				...
				while ($wp_query->have_posts()) {
					...
					$article_image = dfd_aq_resize($img_url, 380, 300, true, true, true);
