...
if ( ! class_exists( 'ReduxFramework_color' ) ) {
    ...
    class ReduxFramework_color {
        ...
        public function render() {
            ...
            echo '<input data-id="' . $this->field['id'] . '" name="' . $this->field['name'] . $this->field['name_suffix'] . '" id="' . $this->field['id'] . '-color" class="redux-color redux-color-init ' . $this->field['class'] . ' dfd-color-picker" data-alpha="true"   type="text" value="' . $this->value . '" data-oldcolor=""  data-default-color="' . ( isset( $this->field['default'] ) ? $this->field['default'] : "" ) . '" />';
