    ...
    if ( ! class_exists( 'ReduxFramework_background' ) ) {
        ...
        class ReduxFramework_background {
            ...
            public function render() {
				...
				echo '<div class="dropdowns-wrap clearfix">';
                ...
                if ( $this->field['background-image'] === true ) {
                    ...
                    echo '<span class="button redux-background-upload" id="' . $this->field['id'] . '-media"><i class="crdash-plus"></i>' . __( 'Upload', 'redux-framework' ) . '</span>';
