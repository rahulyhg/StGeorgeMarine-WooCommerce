    ...
    class ReduxFramework_media {
        ...
        public function render() {
            ...
            //echo '<span class="button media_upload_button" id="' . $this->field['id'] . '-media">' . __( 'Upload', 'redux-framework' ) . '</span>';
				echo '<div class="buttons-cover">';
					echo '<span class="media_upload_button" id="' . $this->field['id'] . '-media"><span class="' . $hide . ' screenshot"><img class="redux-option-image" id="image_' . $this->field['id'] . '" src="' . $this->value['thumbnail'] . '" alt="" target="_blank" rel="external" /></span><span class="no-image-holder '.$placeholder_hide.'"><i class="crdash-plus"></i>'.__('Upload image','dfd').'</span></span>';

					//echo '<span class="button remove-image' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '">' . __( 'Remove', 'redux-framework' ) . '</span>';
					echo '<span class="crdash-delete remove-image ' . $hide . '" id="reset_' . $this->field['id'] . '" rel="' . $this->field['id'] . '"></span>';
				echo '</div>';
