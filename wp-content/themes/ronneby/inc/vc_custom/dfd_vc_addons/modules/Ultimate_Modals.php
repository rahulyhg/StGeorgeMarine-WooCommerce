...
if(!class_exists('Old_Dfd_List_Icon'))
{
	class Old_Dfd_List_Icon
	{
		...
		{
			wp_register_script("ultimate-modernizr",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/min-js/modernizr.custom.min.js',array('jquery'),null);
			//wp_register_script("ultimate-classie",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/min-js/classie.min.js',array('jquery'),null);
			//wp_register_script("ultimate-snap-svg",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/min-js/snap.svg.min.js',array('jquery'),null);
			//wp_register_script("ultimate-frongloop",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/min-js/froogaloop2.min.js',array('jquery'),null);
			//wp_register_script("ultimate-modal",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/min-js/modal.min.js',array('jquery'),null);
			wp_register_script("ultimate-modal-all",get_template_directory_uri().'/inc/vc_custom/dfd_vc_addons/assets/min-js/modal-all.min.js',array('jquery'),null);
		}
