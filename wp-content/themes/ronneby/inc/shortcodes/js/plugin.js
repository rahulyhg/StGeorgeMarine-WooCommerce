			...
			return {
				...
				items: [
				
					{
						type: 'listbox',
						name: 'class',
						label: 'Select defined style',
						'values': [
							{text: 'default', value: ''},
							{text: 'bordered', value: 'table table-bordered'},
							{text: 'striped', value: 'table table-striped'},
							{text: 'hoverable', value: 'table table-hover'},
							{text: 'condensed', value: 'table table-condensed'},
						]
					},
