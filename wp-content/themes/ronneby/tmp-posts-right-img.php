<?php
/*
Template Name: Posts with right aligned image(Deprecated)
*/
...
<section id="layout" class="blog-page">
    ...
    <div class="row">
        ...
        <div class="blog-section sidebar-right post-format-right-image dfd-equal-height-children">
							...
							<div class="six columns post-data">
								<div class="clearfix dfd-vertical-aligned">
									...
									<div class="entry-content">
										...
										<a href="<?php echo the_permalink(); ?>" title="<?php the_title(); ?>" class="more-button <?php echo esc_attr($read_more_style); ?> right" data-lang="en"><?php _e('Continue', 'dfd'); ?></a>
