...
<?php if (isset($product_terms[0]) && !empty($product_terms[0]) && !is_wp_error($product_terms)):
	...
	<span class="byline category">
		<a href="<?php echo esc_url(get_term_link($product_terms[0]->slug, 'my-product_category')); ?>" class="fn" <?php echo $cat_bg_css ?>>
			<span class="cat-name"><?php echo $product_terms[0]->name; ?></span>
		</a>
	</span>
<?php endif;
