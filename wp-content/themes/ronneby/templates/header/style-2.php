			...
			<div class="header-top-panel">
				<div class="row">
					<div class="columns twelve header-info-panel">
						...
						<?php if(isset($dfd_ronneby['header_second_login']) && $dfd_ronneby['header_second_login']) { ?>
							<?php get_template_part('templates/header/block', 'login'); ?>
						<?php } ?>
						
						<?php if(isset($dfd_ronneby['head_second_show_soc_icons']) && $dfd_ronneby['head_second_show_soc_icons']) { ?>
							<div class="widget soc-icons <?php echo esc_attr($header_soc_icons_hover_style) ?>">
								<?php echo crum_social_networks(true); ?>
							</div>
						<?php } ?>
						<?php if(isset($dfd_ronneby['head_second_enable_top_panel_wishlist_link']) && $dfd_ronneby['head_second_enable_top_panel_wishlist_link']) {
