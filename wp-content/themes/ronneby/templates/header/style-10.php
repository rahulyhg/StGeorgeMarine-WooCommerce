...
$show_header_top_panel = isset($dfd_ronneby['header_tenth_top_panel']) && strcmp($dfd_ronneby['header_tenth_top_panel'], 'on') === 0;
if(isset($dfd_ronneby['header_tenth_soc_icons_hover_style']) && !empty($dfd_ronneby['header_tenth_soc_icons_hover_style'])) {
	$header_soc_icons_hover_style = 'dfd-soc-icons-hover-style-'.$dfd_ronneby['header_tenth_soc_icons_hover_style'];
} else {
...
if(!isset($dfd_ronneby['header_tenth_sticky']) || strcmp($dfd_ronneby['header_tenth_sticky'], 'off') !== 0) {
...
$header_container_class .= (isset($dfd_ronneby['head_tenth_enable_buttons']) && strcmp($dfd_ronneby['head_tenth_enable_buttons'], '1') === 0) ? '' : ' dfd-header-buttons-disabled';
$header_container_class .= (isset($dfd_ronneby['header_tenth_logo_align']) && !empty($dfd_ronneby['header_tenth_logo_align'])) ? ' '.$dfd_ronneby['header_tenth_logo_align'] : ' logo_left';
...
if(isset($dfd_ronneby['header_tenth_menu_align']) && !empty($dfd_ronneby['header_tenth_menu_align'])) {
	$header_container_class .= ' '.$dfd_ronneby['header_tenth_menu_align'];
}

if(isset($dfd_ronneby['header_tenth_middle_item']) && !empty($dfd_ronneby['header_tenth_middle_item'])) {
	$header_container_class .= ' with-'.$dfd_ronneby['header_tenth_middle_item'];
}
?>
			...
			<div class="header-top-panel">
				<div class="row">
					<div class="columns twelve header-info-panel">
						...
						<?php if(isset($dfd_ronneby['header_tenth_login']) && $dfd_ronneby['header_tenth_login']) { ?>
							<?php get_template_part('templates/header/block', 'login'); ?>
						<?php } ?>
						
						<?php if(isset($dfd_ronneby['head_tenth_show_soc_icons']) && $dfd_ronneby['head_tenth_show_soc_icons']) { ?>
							<div class="widget soc-icons <?php echo esc_attr($header_soc_icons_hover_style) ?>">
								<?php echo crum_social_networks(true); ?>
							</div>
						<?php } ?>
						<?php if(isset($dfd_ronneby['head_tenth_enable_top_panel_wishlist_link']) && $dfd_ronneby['head_tenth_enable_top_panel_wishlist_link']) {
			...
			<div class="row">
				<div class="columns twelve">
					...
					<div class="dfd-header-middle-content">
						<?php
						if(isset($dfd_ronneby['header_tenth_middle_item']) && $dfd_ronneby['header_tenth_middle_item'] == 'banner' && isset($dfd_ronneby['header_tenth_banner_image']['url']) && !empty($dfd_ronneby['header_tenth_banner_image']['url']) ) {
							$banner_url = (isset($dfd_ronneby['header_tenth_banner_url']) && !empty($dfd_ronneby['header_tenth_banner_url'])) ? $dfd_ronneby['header_tenth_banner_url'] : home_url();
							?>
							<a class="dfd-header-banner-link" href="<?php echo esc_url($banner_url) ?>" title="<?php echo esc_attr__('Banner','dfd') ?>"><img src="<?php echo esc_url($dfd_ronneby['header_tenth_banner_image']['url']) ?>" alt="<?php echo esc_attr__('Banner','dfd') ?>" /></a>
							<?php
						} else {
