<?php
/*
Template Name: Portfolio 1 col Excerpt + right sidebar(Deprecated)
*/
...
<section id="layout" class="portfolio-page dfd-sidebar-right dfd-equal-height-children">
    ...
    <div class="row">
        ...
        <div id="portfolio-page" class="nine columns one-column-portfolio dfd-eq-height module-eq-height">
                ...
                while (have_posts()) : the_post();
					...
					<div class="project project-one-column one-photo clearfix <?php echo esc_attr($folio_hover_style); ?>">
						<div class="eight columns">
							<div class="entry-thumb dfd-vertical-aligned">
						...
						<article class="four columns">
							<div class="dfd-vertical-aligned">
								...
								<div class="entry-content">
									<p><?php echo cut_string(get_the_excerpt(), 150); ?></p>
