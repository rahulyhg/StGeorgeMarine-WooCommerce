<?php
/*
  Template Name: Portfolio grid 2 col Mini + left sidebar(Deprecated)
 */
...
<section id="layout" class="portfolio-page dfd-sidebar-left dfd-equal-height-childrendfd-equal-height-children">
	...
	<div class="row">
		...
		<div id="portfolio-page" class="nine columns mini dfd-eq-height">
